...
players_decisions_in_factory_offert(PlayersState,
                                   ...
                                   [],
                                   NewPlayersState,
                                   _):- PlayersState == NewPlayersState, !.
...
put_taked_tokens_in_pattern_line([],
                                 ...
                                 _,
                                 NewPatternLines,
                                 _) :- PatternLines == NewPatternLines.
...
take_from_center(CenterTokens,
                TakedTokens,
                NewCenterTokens):- write('You choose take tokens from center'),nl,
                                   write('Those are the tokens in the center of the table:'),nl,
                                   sort(0, @=<, CenterTokens, SortedCenter),
                                   write(SortedCenter),nl,
                                   write('The options that you have are the following'),nl,
                                   sort(SortedCenter, _),

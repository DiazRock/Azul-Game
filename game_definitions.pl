...
player_in_factory_offert( CurrentPlayerState, 
                          ...
                          NewPState):- format_state(
                                             ...
                                             format('pasé el fill_pattern_line'),nl,
                                             ...
                                             NewFloorLine],
                                             format('*******************************************'),nl,
                                             format('The pattern line elected is ~w',
                                             PatternLineElected),nl,
                                             format('This is the new pattern line ~w',
                                             PatternLineNew),nl,

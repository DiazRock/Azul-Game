...
player_in_factory_offert( CurrentPlayerState,
                          ...
                          NewPState):- format_state(
                                             ...
                                             NewCenterTokens,
                                             TakedTokens),
                                             compound_name_arguments(CurrentPlayerState,
                                             PlayerName,
                                             [PatternLines,
                                             Wall,
                                             ScoreTrack,
                                             FloorLine]),
                                             format('~w has the following taked tokens: ', PlayerName),nl,
                                             write(TakedTokens),nl,
                                             format('~w has the following pattern_line', PlayerName),nl,
                                             ...
                                             PossibleElectionsWithoutTokenInWall,
                                             PatternLineElected),
                                             format('The pattern line elected is ~w and the index is ~w',
                                             [PatternLineElected, IndexFromPossibleElection]),nl,
                                             nth1(IndexInTheOriginalPatternLine,
                                             PatternLines, PatternLineElected),
                                             nth1(IndexInTheOriginalPatternLine,
                                             PatternLines, PatternLineElected, RemainderPatternLines),
                                             format('So we have this rest of pattern lines:'),nl,
                                             format_wall(RemainderPatternLines),
                                             format('and the original Index is ~w', IndexInTheOriginalPatternLine),nl,
                                             ...
                                             TakedTokens,
                                             RemainderFromTaked),
                                             format('Now we have this part of the pattern for fill ~w and this remainder ~w',
                                             [ForFillPattern, RemainderFromTaked]),nl,
                                             append(ForFillPattern,
                                             PartWithColor,
                                             NewPatternLine),
                                             format('This is the new pattern line ~w', NewPatternLine),nl,
                                             append(FloorLine,
                                             RemainderFromTaked,
                                             NewFloorLine),
                                             ...
                                             ScoreTrack,
                                             NewFloorLine],
                                             format('The New pattern lines for the ~w are', PlayerName),nl,
                                             format('~w ', NewPatternLines), nl,
                                             format('And the floor line for that player is'),nl,
                                             format('~w ', NewFloorLine),nl,
                                             format('Now the center of the table is'),nl,
                                             write(CenterTokens), nl,
                                             write('Salí del player...'),nl,
                                             format_player(NewPState).
...
take_from_factory_list(FactoryList,
                       TakedTokens,
                       NewFactoryList,
                       TokensToTheCenter ):- write('You choose take tokens from factory list'),nl,
